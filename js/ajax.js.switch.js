...
(function($){
	$.fn.ajaxJSSwitch=function(o){
		var customObject={
            ...
            MSIE9 = (navigator.userAgent.toLowerCase().indexOf('msie 9')!=-1),
            MSIE8 = (navigator.userAgent.toLowerCase().indexOf('msie 8')!=-1),
            xhr,
...
//add events
			...
			$("a, area", customObject.webSite).on("click", followLink);
			$(".select-menu").on("change", followLink);
			$("#searchButton", ".search").on("click", searchButton);
			$("input[name='s']", ".search").on("keypress", pressKey);
